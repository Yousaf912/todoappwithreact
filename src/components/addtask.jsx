...
export default function Addtask({ addtask ,deletAll }) {
  ...
  return (
    <div className='border-0 bg-white ms-lg-5 me-lg-5 d-md-flex flex-row justify-content-lg-between p-2 rounded-5'>
      ...
      <button className='border-0 bg-black text-white px-1 me-lg-4 rounded-5 px-2' onClick={deletAll}> Delete All</button>
    </div>
  )
}
